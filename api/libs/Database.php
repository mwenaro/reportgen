...
// public function __construct($DB_TYPE, $DB_NAME = 'C:\software\repo\tmtsrg\api\resources\shule.sqlite3', $DB_HOST = null, $DB_USER = null, $DB_PASS = null) {
    public function __construct($DB_TYPE, $DB_NAME=null, $DB_HOST = null, $DB_USER = null, $DB_PASS = null) {
//            phpinfo(); exit();  
...
//            $url="http://127.0.0.1:7173/api/resources/shule.sqlite3";
            try {
...
//    }
    ...
    function updateMarks($tab2, $data, $flds, $key) {
        ...
        foreach ($data as $value) {
            ...
            $this->update($tab2, $dat, [$key => $value[$key], 'uk' => 'yes']);
        }
    }
    ...
    function upDateS($data) {
        ...
        foreach ($data as $student) {
            ...
            foreach ($student as $key => $value) {
                $bBox[$student['studentId']][$key] = $value;
                $bBox[$student['studentId']]['unique_key'] = uniqid();
            }
        }
...
//            $sBox['unique_key'] = uniqid();
//            $bBox[] = $sBox;
        }
//        var_dump($sBox);
//        print_r(json_encode($sBox));
        return $bBox;
    }
...
//            $this->process_update($this->data, 'students');
//            $this->process_update($this->data, 'students');
            if (strpos($sql, "students")):
//                $this->updateMarks("marks", $this->data, ['unique_key' => 'uk'], 'studentId');
//                $this->upDateS($this->data);
//                $this->data= $this->upDateS($this->data);
//                foreach ($this->data as  $value) {
//                    $this->update('students', $value, ['studentId'=>$value['studentId']]);
//                }
            endif;
        } catch (PDOException $exc) {
            $exc->getMessage();
