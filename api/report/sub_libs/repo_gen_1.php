...
//        $t = 'F' . $this->student->form . 'T' . TERM;
        ...
        $this->graphY(
                $this->graphFrameLeftX, $this->graphFrameTopY, $this->w * 0.6, $this->graphFrameHeight, array('data' => array(
                'KCPE' => $this->mat->grade($this->student->kcpe >= 0 ? round($this->student->kcpe / 5, 0) : 1)['p'],
                $t => $this->student->mp,
            ), 'font' => array('style' => 'B')));

        $this->graphY(
                ($this->graphFrameLeftX + $this->w * 0.58), $this->graphFrameTopY, $this->w * 0.35, $this->graphFrameHeight, array(
