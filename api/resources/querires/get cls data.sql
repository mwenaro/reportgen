SELECT DISTINCT students.adm, students.gen, exams.examId, students.name, oppener.kcpe, students.form, subjects.short_name as sub, students.adm, COUNT(exams.examId) as exams, (marks.score*100/tests.max_score) as score
