<nav class="left-sidebar bg-black-300 box-shadow navbar-default">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-nav">
                <ul class="side-nav ">
                    ...
                    <li>
                        <a href="<?php echo URL.'dashboard/dashboard';?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
                    ...
                    <li class="has-children">
                        ...
                        <ul class="child-nav">
                            <li><a href="<?php echo URL.'course/courseManage';?>"><i class="fa fa-bars"></i> <span>Create Subject</span></a></li>
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        <li><a href="<?php echo URL.'student/addStudent';?>"><i class="fa fa-bars"></i> <span>Add Students</span></a></li>
                        <li><a href="<?php echo URL.'student/addStudent';?>"><i class="fa fa fa-server"></i> <span>Manage Students</span></a></li>
