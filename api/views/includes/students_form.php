<form    data-ng-submit="updateEntry({'request':'update','table':'students','data':person})">
    ...
    <div class="form-group">
        <p ng-if="editPersonActive===false"><button type="submit" class="btn btn-primary" ><span class="fa fa-user"></span>  Add Student</button></p>
        <p ng-if="editPersonActive === true"> <button type="submit" class="btn w3-blue" ><span class="fa fa-user"></span>  Update Info</button></p>
    </div>
