...
<div class="row w3-container"  data-ng-controller="dataController" data-ng-init="<?php echo(!empty($data)?"edit.data='{$s}":'');?> edit.show = false;<?php echo ($flag?'edit.show=true':'');?>">
