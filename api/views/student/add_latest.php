...
<div class="row w3-container" id="big-Con" data-ng-controller="dataController" data-ng-init="showForm = false;app_page='students'">
    <!---The ng-show--->
    <p data-ng-show="showForm === true">
    </p>


    <div class="col-lg-5" data-ng-show="showForm === false">
        <form    class1="w3-form w3-card-4 form"   data-ng-submit="insertFormData({'request':'insert','table':app_page,'data':fdata})">
    ...
    <div class="col-lg-5" data-ng-show="showForm === true">

        <?php // include INCLUDES.'eddit.php';?>
        <form    data-ng-submit="updateEntry({'request':'update','table':app_page,'data':edit.data})">
            <!--data-ng-submit="updateEntry({'request':'update','table':app_page,'data':edit.data})"  >-->
    ...
    <div class="col-lg-7 " data-ng-show="showForm === false">
        <table cliass="w3-table-all  w3-responsive" class="table table-condensed table-bordered table-hover table-responsive table-striped" data-ng-init=''  >
            ...
            <tbody data-ng-init="getData({'request': 'all', 'table':app_page})">
                ...
                <tr data-ng-repeat="student in data.q1">
                    ...
                    <td><button class="btn btn-danger" data-ng-click="deleteEntry({'update':{'request':'SELECT * FROM students WHERE isDeleted IS 0', 'table':app_page}, 'id':id, 'table':app_page, 'request':'delete', 'data':{'isDeleted':1}})"><span class="fa fa-trash"></span>Delete</button></td>
                </tr>
            </tbody>
        </table>
    </div>
