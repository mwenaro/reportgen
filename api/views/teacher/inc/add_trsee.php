...
]"  data-ng-controller="trsController">
    ...
    <form    class="w3-form"   >
        <fieldset class="w3-container" >
            ...
            <div class="form-group  row" style="margin-top:2px">
                ...
                <p ng-if="editPersonActive === false" class="col-lg-6 col-md-6"><input placeholder="Staff Romm Code" type="numbert" class="w3-input" name="staff_code" id="teacher_code" data-ng-model="person.staff_code" ></p>
                <p  ng-if="editPersonActive === true" class="col-lg-6 col-md-6"><input placeholder="Staff Romm Code" type="text" class="w3-input" name="staff_code" id="teacher_code" data-ng-model="person.staff_code" ></p>
            ...
            <div class="form-group row">
                ...
                <p class="col-md-6">
                    ...
                    <select name="sub2" class="w3-select" data-ng-model="person.sub2">
                        ...
                        <option ng-repeat="sub in subs|orderBy:'name'" value="{{sub.subjectId}}">{{sub.name|uppercase}}</option>
                    </select>
                </p>
            </div>
            ...
            <div class="form-group " ng-if="editPersonActive === false">
                ...
                <input class="col-lg-6 col-md-6" type="password"  class="w3-input " name="password1" id="password1" data-ng-model="password_confirm" >
               </p>
            </div>
...
<data-ng-include src="'http://127.0.0.1:7173/api/views/includes/teachers_form.php'"></data-ng-include>
<!--/****************************************************************************************************************/-->
