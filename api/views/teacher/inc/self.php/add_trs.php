...
<!--            <div class="form-group" data-ng-if="editPersonActive === true"></div>-->
            ...
            <div class="form-group" style="margin-top:2px">
               <label class='w3-label'  class="w3-half">Staff Romm Code</label>
                <p class="w3-half" ng-if="editPersonActive===false"><input placeholder="Staff Romm Code" type="numbert" class="w3-input" name="staff_code" id="teacher_code" data-ng-model="person.staff_code" ></p>
                <p class="w3-half" ng-if="editPersonActive===true"><input placeholder="Staff Romm Code" type="text" class="w3-input" name="staff_code" id="teacher_code" data-ng-model="person.staff_code" ></p>

            </div>
            <div class="form-group">
               <label class='w3-label'  class="w3-half">First Name :</label>
                <input class="w3-half" placeholder="First Name" type="text" class="w3-input"  name="first_name" data-ng-model="person.first_name" required >
            </div>
            <!--                <div class="form-group">
            ...
            <div class="form-group">
               <label class='w3-label'  class="w3-half">Last Name:</label>
                <input class="w3-half" placeholder="Last Name" type="text" class="w3-input" name="last_name" id="lname" data-ng-model="person.last_name" required >
            </div>

            <div class="form-group">
               <label class='w3-label'  class="w3-half">Title</label> 
                <select class="w3-half" required name="title" class="w3-select" data-ng-model="person.title">
            ...
            <div class="form-group"><label class='w3-label'  class="w3-half">Teacher Type <small>i.e. tsc, bom etc</small></label>
                <select required name="type" class="w3-select w3-half" data-ng-model="person.type">
            ...
            <div class="form-group">
               <label class='w3-label'  class="w3-half">Gender</label>
                <input class="w3-half w3-radio" type="radio" data-ng-model="person.gen" name="gen" value="f" > <span>Female</span>
                <input class="w3-half w3-radio" type="radio" data-ng-model="person.gen" name="gen" value="m" > <span>Male</span>
            ...
            <div class="form-group">
               <label class='w3-label'  class="w3-half">Mobile</label>
                <input type="tel" placeholder="Phone Number" class="w3-input w3-half" name="phone" id="mobile"  placeholder="Phone" required data-ng-model="person.phone">
            </div>
            <!--                <div class="form-group">
            ...
            <div class="form-group" ng-if="editPersonActive===false">
               <label class='w3-label'  class="w3-half">Passward</label>
                <input type="password"  class="w3-input w3-half" name="password" id="password" data-ng-model="person.password" >{{person.password}}
                <!--/********************************************************************************************************************************************************/-->
               <label class='w3-label'  class="w3-half">Confirm Password</label>
                <input  type="password"  class="w3-input w3-half" name="password1" id="password1" data-ng-model="password_confirm" >
