            ...
            <div>
                ...
                <div class="w3-row">
                    <div class="w3-col-md-4">
                        <form action="/api/report/graph_new.php" method="post" target="_BLANK" data-ng-if="repo.allowPrinting">
                    ...
                    <div class="w3-col-md-4">
                        <form action="/api/report/marklist/graph_new.php" method="post" target="_BLANK" data-ng-if="repo.allowPrinting">
                    <!--<input type="hidden" name="data" value="{{repo.data}}">-->
                            <input type="hidden" name="data" value="{{repo.data}}">
                    ...
                    <div class="w3-col-md-4">
                        <form action="/api/report/meritlist/graph_new.php" method="post" target="_BLANK" data-ng-if="repo.allowPrinting">
                    <!--<input type="hidden" name="data" value="{{repo.data}}">-->
                            <input type="hidden" name="data" value="{{repo.data}}">
