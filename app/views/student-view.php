...
/*****************************************************************************************************-->
<div class=" " id="big-Con" data-ng-controller="studentController" data-ng-init="showForm = false; app_page = 'students'">
    <!--/*********************************************************************************************/-->
    <div id="nav_inner" class="w3-panel w3-round" style="background:#e3e3e3;margin-top: 6px;">
        <h3 class="page_title w3-half w3-text-blue">Student Page</h3>
        ...
        <button class="button btn-primary" data-ng-click="changeInclude('add')">Add/Remove Student</button>
        <button class="button btn-primary" data-ng-click="changeInclude('album')">Student Album</button>
        </ul>
    ...
    <!--The ng-show-->
    <p data-ng-show="showForm === true" data-ng-init="editPersonActive = false">
    </p>
  <!--/*****************************************************************************************/
                              Innner Include
  *****************************************************************************************/-->
